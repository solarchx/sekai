        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg mb-6">
                <div class="p-6" style="background: linear-gradient(to right, #06b6d4, #0891b2); color: white;">
                    <h3 class="text-2xl font-bold">{{ $activity->subject->name ?? __('N/A') }}</h3>
                    <p class="mt-2">{{ $activity->class->name ?? __('N/A') }} - {{ __('Taught by') }}
                    ...
                    @if(auth()->user()->role !== 'STUDENT')
                        <div class="mt-6 flex flex-wrap gap-3">
                            <a href="{{ route('activities.edit', $activity) }}"
                                class="bg-cyan-600 hover:bg-cyan-700 text-white px-4 py-2 rounded-lg shadow-md transition-colors inline-flex items-center">
                            ...
                            <a href="{{ route('score-distributions.index', $activity->id) }}"
                            ...
                            <a href="{{ route('student-scores.index', $activity->id) }}"
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6" style="background: linear-gradient(to right, #06b6d4, #0891b2); color: white;">
                    ...
                    <p class="mt-2">{{ __('View and manage attendance forms for this activity.') }}</p>
                </div>
                <div class="p-6">
                    @if(auth()->user()->role !== 'STUDENT')
                        <div class="flex justify-between items-center mb-6">
                            <h4 class="text-xl font-semibold text-gray-900 dark:text-gray-100">{{ __('Forms List') }}</h4>
                            <a href="{{ route('activity-forms.create', ['activity_id' => $activity->id]) }}"
