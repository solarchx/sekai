        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6" style="background: linear-gradient(to right, #10b981, #059669); color: white;">
                    <h3 class="text-2xl font-bold">{{ __('Activity Report Management') }}</h3>
                    <p class="mt-2">{{ __('View anonymous reports about teacher performance.') }}</p>
                </div>
                <div class="p-6">
                    ...
                    @if($teacherId)
                        <div class="flex justify-between items-center mb-6">
                            <h4 class="text-xl font-semibold text-gray-900 dark:text-gray-100">{{ __('Reports List') }}
                                ({{ $reports->total() }})</h4>
                        </div>
                        ...
                        <div class="space-y-4">
                            @forelse($reports as $report)
                                <div
                                    class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 {{ $report->deleted_at ? 'opacity-50' : '' }}">
                            ...
                            @empty
                                <div
                                    ...
                                    {{ __('No reports found for this teacher.') }}
                                </div>
                            @endforelse
                        </div>
