        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6" style="background: linear-gradient(to right, #8b5cf6, #ec4899); color: white;">
                    <h3 class="text-2xl font-bold">{{ __('Class Management') }}</h3>
                    <p class="mt-2">{{ __('Manage class groups and their details.') }}</p>
                </div>
                <div class="p-6">
                    <x-soft-delete-filter />
                    <div class="flex justify-between items-center mb-6">
                        <h4 class="text-xl font-semibold text-gray-900 dark:text-gray-100">{{ __('Classes List') }}
                            ({{ $classes->total() }})</h4>
                        @if(!$showDeleted)
