                ...
                <form method="POST" action="{{ route('announcements.store') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <select name="scope" id="scope"
                            ...
                            <option value="PUBLIC" {{ old('scope') == 'PUBLIC' ? 'selected' : '' }}>
                                {{ __('Public (Everyone)') }}</option>
                            <option value="TEACHERS" {{ old('scope') == 'TEACHERS' ? 'selected' : '' }}>
                    ...
                    <div class="flex justify-end gap-4">
                        ...
                        <button type="submit"
                            class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg shadow-md transition-colors">{{ __('Create') }}</button>
                    </div>
                </form>
            </div>
        </div>
