    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            @if(auth()->user()->role !== 'STUDENT')
                <a href="{{ route('announcements.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg shadow-md transition-colors">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                    <div class="flex justify-between items-start mb-4">
                        <div class="flex-1">
                            <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100">{{ $announcement->title }}</h3>
                        ...
                        <div class="flex gap-2">
                            <a href="{{ route('announcements.edit', $announcement) }}" class="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded text-sm">Edit</a>
