    ...
    <div class="max-w-md mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl dark:shadow-2xl dark:shadow-black/50 p-8 border border-gray-100 dark:border-gray-700">
            <form method="POST" action="{{ route('register') }}">
                ...
                <!-- Identifier -->
                <div class="mb-6">
                    <x-input-label for="identifier" :value="__('Username')" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2" />
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <i class="bi bi-at text-gray-400 dark:text-gray-500"></i>
                        </div>
