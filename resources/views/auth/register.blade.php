<x-guest-layout>
    <div class="max-w-md mx-auto">
        ...
        <div class="text-center mb-8">
            <div
                class="mb-4 inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-600 dark:from-purple-600 dark:to-pink-700 rounded-lg shadow-lg">
            ...
            <p class="text-gray-600 dark:text-gray-400">{{ __('Join Sekai to get started') }}</p>
        </div>
        ...
        <div
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-6">
                    <x-input-label for="identifier" :value="__('ID Number')"
                        class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2" />
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        ...
                        <x-text-input id="identifier"
                            class="block w-full pl-10 pr-4 py-2.5 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 focus:border-transparent transition"
                            type="text" name="identifier" :value="old('identifier')" required autocomplete="identifier"
                ...
                <div class="space-y-4">
                    <x-primary-button
                        class="w-full justify-center py-2.5 bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-600 dark:to-pink-700 hover:from-purple-700 hover:to-pink-700 dark:hover:from-purple-700 dark:hover:to-pink-800 font-semibold transition shadow-lg">
                        {{ __('Create Account') }}
                    </x-primary-button>
                </div>
                ...
                <div class="mt-6 relative">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span
                            class="px-2 bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400">{{ __('Already have an account?') }}</span>
                    </div>
                </div>
        ...
        <div class="mt-8 text-center text-sm text-gray-600 dark:text-gray-400">
            <p>{{ __('By signing up, you agree to our Terms of Service') }}</p>
        </div>
    </div>
</x-guest-layout>