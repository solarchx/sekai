                ...
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('periods.store') }}">
                        ...
                        <div class="flex justify-end gap-4">
                            <a href="{{ route('periods.index', ['semester_id' => request('semester_id')]) }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg shadow-md transition-colors">Cancel</a>
