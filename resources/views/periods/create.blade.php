                ...
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('periods.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="time_begin" id="time_begin" value="{{ old('time_begin') }}"
                                placeholder="14:30"
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="time_end" id="time_end" value="{{ old('time_end') }}"
                                placeholder="15:45"
                                pattern="^(0[0-9]|1[0-9]|2[0-3]):[0-5][0-9]$"
                                title="Please enter time in 24-hour format HH:MM (e.g., 08:00, 14:30)"
                        ...
                        <div class="flex justify-end gap-4">
                            <a href="{{ route('periods.index', ['semester_id' => $selectedSemesterId, 'major_id' => $selectedMajorId, 'grade_id' => $selectedGradeId]) }}"
