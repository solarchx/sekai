            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6" style="background: linear-gradient(to right, #f59e0b, #d97706); color: white;">
                    <h3 class="text-2xl font-bold">
                        {{ __('Welcome, Professor :name!', ['name' => auth()->user()->name]) }}</h3>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <h5 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                                        {{ __('My Classes') }}</h5>
                                    <p class="text-gray-600 dark:text-gray-400">{{ __('Manage your assigned classes') }}
                                    </p>
                        ...
                        <div
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-600 dark:text-gray-400">{{ __('Record student attendance') }}
                                    </p>
                                    <a href="{{ route('activity-presences.index') }}"
                                        class="mt-2 inline-block text-green-600 dark:text-green-400 hover:text-green-800 dark:hover:text-green-300">{{ __('Mark Attendance →') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
