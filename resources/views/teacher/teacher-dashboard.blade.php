                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <a href="#"
                                        class="mt-2 inline-block text-purple-600 dark:text-purple-400 hover:text-purple-800 dark:hover:text-purple-300">Record
                                        Grades →</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <h5 class="text-lg font-medium text-gray-900 dark:text-gray-100">Class Materials
                                    </h5>
                                    <p class="text-gray-600 dark:text-gray-400">Upload and manage class materials</p>
                                    <a href="#"
                                        class="mt-2 inline-block text-red-600 dark:text-red-400 hover:text-red-800 dark:hover:text-red-300">Manage
                                        Materials →</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-8">
                            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                                <div class="p-6"
                                    ...
                                    <h3 class="text-2xl font-bold">My Teaching Schedule</h3>
                                    <p class="mt-2">
                                        @if($currentSemester)
