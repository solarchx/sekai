...
<head>
    ...
    <title>{{ __('Wrong Way') }} - {{ config('app.name', 'Laravel') }}</title>
</head>
...
<body class="bg-black overflow-hidden max-w-screen max-h-screen">
    ...
    <img src="{{ asset('img/storylock/lock_side_closed.png') }}"
        class="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-4/5 z-1" alt="Left Lock I">

    <img src="{{ asset('img/storylock/lock_side_closed.png') }}"
        class="absolute top-3/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-4/5 z-1" alt="Left Lock II">


    <img src="{{ asset('img/storylock/lock_main_closed.png') }}"
        class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4/5 z-2" alt="Center Lock I">


    <img src="{{ asset('img/storylock/lock_side_closed.png') }}"
        class="absolute top-1/4 left-3/4 -translate-x-1/2 -translate-y-1/2 w-4/5 z-1" alt="Right Lock I">

    <img src="{{ asset('img/storylock/lock_side_closed.png') }}"
        class="absolute top-3/4 left-3/4 -translate-x-1/2 -translate-y-1/2 w-4/5 z-1" alt="Right Lock II">
    ...
    <div class="absolute top-3/4 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center text-white z-3">
        ...
        <a href="{{ route('dashboard') }}"
            class="font-monaco mt-6 inline-block outline-none text-white px-4 py-2 rounded-lg shadow-md transition-colors">
