...
-- Dumping data for table sekai.classes: ~2 rows (approximately)
...
-- Dumping data for table sekai.migrations: ~4 rows (approximately)
...
-- Dumping data for table sekai.score_distribution_weights: ~0 rows (approximately)

-- Dumping data for table sekai.student_scores: ~0 rows (approximately)

-- Dumping data for table sekai.student_score_details: ~0 rows (approximately)

-- Dumping data for table sekai.subjects: ~0 rows (approximately)

-- Dumping data for table sekai.users: ~5 rows (approximately)
REPLACE INTO `users` (`id`, `name`, `email`, `identifier`, `email_verified_at`, `password`, `remember_token`, `role`, `deleted_at`, `created_at`, `updated_at`) VALUES
	(1, 'Kanade Yoisaki', 'k.nightcord@25.ji', '626262626', NULL, '$2y$10$iS3EXwwWPO0xleQ/8cWYG.oDfxiov5Dy93obSZHvWFVFIrbWdaThe', NULL, 'ADMIN', NULL, '2026-02-16 17:11:43', '2026-02-16 17:11:43'),
	(2, 'Mafuyu Asahina', 'yuki.nightcord@25.ji', '62626263', NULL, '$2y$10$1BM/LFEoRgQywAOJxrHOe.6bkn1f37mzWqGMFYbZvSVKKa3XQwDDG', NULL, 'VP', NULL, '2026-02-16 17:14:22', '2026-02-16 17:14:22'),
	(3, 'Mizuki Akiyama', 'amia.nightcord@25.ji', '62626264', NULL, '$2y$10$aka1F/vNZI.niycs9wpGQOC9.BxoZ6XsLDu7hVCWx0kGYLlG8HaJG', NULL, 'TEACHER', NULL, '2026-02-16 17:15:23', '2026-02-16 17:15:23'),
	(4, 'Ena Shinonome', 'enanan.nightcord@25.ji', '62626265', NULL, '$2y$10$h9Qtfl7o2H3nxxz4z5O/Ne/s2gHP6bAUaTwtB55v1EjRJDlQfdLw2', NULL, 'STUDENT', NULL, '2026-02-16 17:16:10', '2026-02-16 17:16:10'),
	(6, 'Hatsune Miku', 'miku.nightcord@25.ji', '62626266', NULL, '$2y$10$wRwTIWMWgWsZxi4.plKzSewHazI0larT/vX6xSFaa6au5xyNFG7Yq', NULL, 'STUDENT', NULL, '2026-02-16 18:17:46', '2026-02-16 18:17:46');
